...
export const CVManager = () => {
  ...
  return (
    <div className="page-container" style={{ maxWidth: '920px' }}>
      ...
      <div className="glass-panel" style={{ padding: '1.25rem', marginBottom: '1.75rem', display: 'flex', alignItems: 'flex-start', gap: '0.85rem' }}>
        <div style={{ color: '#34D399', fontSize: '1.3rem', marginTop: '2px', flexShrink: 0 }}>
          <LockClosedIcon width={20} height={20} />
        </div>
        <div>
          <h4 style={{ fontSize: '0.95rem', color: '#FFF', marginBottom: '0.2rem' }}>
      ...
      <div className="glass-card" style={{ padding: '1.75rem' }}>
        <h3 style={{ fontSize: '1.1rem', color: '#FFF', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.45rem' }}>
          <StarIcon style={{ color: 'var(--color-gold-light)' }} width={16} height={16} /> Conseils Recrutement Tech Maroc pour Lauréats Bac+2
        </h3>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1rem' }}>
          <div style={{ background: 'var(--bg-elevated)', padding: '1rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border-subtle)' }}>
            <h4 style={{ fontSize: '0.88rem', color: 'var(--color-gold-light)', marginBottom: '0.35rem' }}>
